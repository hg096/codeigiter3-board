            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    if (isset($_SESSION['user_id']) == false) { ?>
                        <a class="nav-link" href="/ci3-board/site/login">로그인</a>
                    <?php
                    } else {
                    ?>

                        <a class="nav-link" href="/ci3-board/action/logout">로그아웃</a>
                        <a class="nav-link" href="/ci3-board/action/withdrawal">회원탈퇴</a>
                    <?php
                    }
                    ?>
